...
bedrock.events.on('bedrock-express.configure.routes', function(app) {
  var basePath = bedrock.config['identity-http'].basePath;
...
function updateIdentity(req, operation, callback) {
  async.auto({
    ...
    updateRoles: ['getId', function(callback, results) {
      ...
      // FIXME: unnecessary now that we have _ensureSysResourceRoleValid
      //        except for the fact that we need to implement IDENTITY_ADMIN
