...
config['identity-rest'].test.testUser = 'testuser';

config['identity-rest'].identities.push(
  createIdentity(config['identity-rest'].test.testUser));

var testKeyPair = createKeyPair({
  userName: config['identity-rest'].test.testUser,
...
config['identity-rest'].keys.push(testKeyPair);
